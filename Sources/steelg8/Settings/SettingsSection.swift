...
/// SwiftUI 设置容器左侧的分组。Phase 12.2 引入。
enum SettingsSection: String, Identifiable, CaseIterable, Hashable {
    ...
    var title: String {
        ...
        case .providers:      return "供应商与模型"
        case .modelProfiles:  return "模型画像与定价"
    ...
    var systemImage: String {
        ...
        case .modelProfiles:  return "cube.box"
    ...
    enum Group: String, CaseIterable, Identifiable {
        ...
        var sections: [SettingsSection] {
            ...
            case .model:   return [.providers, .modelProfiles]
